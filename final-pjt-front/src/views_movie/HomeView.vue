<template>
  <div>
    ...
    <h2 class="title-font" style="margin-bottom:60px">DOGFLIX 알고리즘이 {{user.username}}님에게 추천하는 영화 페이지</h2>
    ...
    <h3 class="content-font" v-if="users_movies.length === 30">DOGFLIX 유저들이 많이 리뷰한 영화</h3>
